...
- [ ] Implement `run` subcommand end-to-end
- [ ] Implement `validate` subcommand
- [ ] Implement `morris`, `sobol`, `gp-train` subcommands
- [ ] Smoke test: `cargo run -- validate --params default` completes without panic for N=50,
  T=1000
